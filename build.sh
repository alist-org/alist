...
ldflags="\
-w -s \
-X 'github.com/alist-org/alist/v3/internal2/conf.BuiltAt=$builtAt' \
-X 'github.com/alist-org/alist/v3/internal2/conf.GoVersion=$goVersion' \
-X 'github.com/alist-org/alist/v3/internal2/conf.GitAuthor=$gitAuthor' \
-X 'github.com/alist-org/alist/v3/internal2/conf.GitCommit=$gitCommit' \
-X 'github.com/alist-org/alist/v3/internal2/conf.Version=$version' \
-X 'github.com/alist-org/alist/v3/internal2/conf.WebVersion=$webVersion' \
"
