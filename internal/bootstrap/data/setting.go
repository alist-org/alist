...
(?U)access_token=(.*)&`,
		...
		// plugin settings
		{Key: conf.PluginAutoUpdate, Value: "false", Type: conf.TypeBool, Group: model.GLOBAL, Flag: model.PRIVATE},
		{Key: conf.PluginRepository, Value: "", Type: conf.TypeText, Group: model.GLOBAL, Flag: model.PRIVATE},
	}
	if flags.Dev {
