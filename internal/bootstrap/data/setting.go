...
func InitialSettings() []model.SettingItem {
	...
	"epub": {
		...
		{Key: conf.CustomizeHead, Value: `<script src="https://fastly-polyfill.io/v3/polyfill.min.js?features=String.prototype.replaceAll"></script>`, Type: conf.TypeText, Group: model.GLOBAL, Flag: model.PRIVATE},
